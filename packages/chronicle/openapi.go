		...
		Components: openAPIComponents{
			...
			Schemas: map[string]openAPISchema{
				...
				"TesseraStatus": objectSchema(
					[]string{"storage_backend", "log_dir", "signer", "verifier_key", "next_index", "integrated_size", "witness_enabled"},
					map[string]openAPISchema{
						...
						"witness_enabled":   {Type: "boolean", Example: true},
						"witness_policy":    {Type: "string", Example: "/etc/chronicle/witness/policy"},
						"witness_fail_open": {Type: "boolean", Example: false},
						"witness_timeout":   {Type: "string", Example: "5s"},
					},
				),
