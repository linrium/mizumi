...
CHECKPOINT_PATH = os.getenv(
    ...
    "s3a://unitycatalog/vietjetair/checkpoints/vietjetair_bookings_prod_bronze/raw_customer_events_v1",
)
...
def build_session() -> SparkSession:
    return (
        SparkSession.builder.appName("vietjetair-stream-raw-customer-events-to-bronze")
