...
SOURCE_PATH = "s3a://unitycatalog/vietjetair/vietjetair_bookings_prod_bronze/raw_customer_events_v1"
TARGET_PATH = "s3a://unitycatalog/vietjetair/vietjetair_bookings_prod_silver/customers_v1"
...
def build_session() -> SparkSession:
    return (
        SparkSession.builder.appName("vietjetair-build-customers-silver")
    ...
    with open_dagster_pipes() as pipes:
        ...
        candidate_df = (
            parsed_df.select(
                ...
                F.upper(F.col("event.membership_tier")).alias("membership_tier"),
                F.upper(F.col("event.home_airport")).alias("home_airport"),
                F.col("event.email_opt_in").alias("email_opt_in"),
