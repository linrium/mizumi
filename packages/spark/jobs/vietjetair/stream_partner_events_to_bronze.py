...
CHECKPOINT_PATH = os.getenv(
    ...
    "s3a://unitycatalog/vietjetair/checkpoints/vietjetair_partnership_prod_bronze/partner_events_v1",
)
...
def build_session() -> SparkSession:
    return (
        SparkSession.builder.appName("vietjetair-stream-partner-events-to-bronze")
