...
const DEFAULT_PANELS: Panel[] = [
  ...
  {
    id: "city-priority-heatmap",
    title: "City Activation Priority - Customers by Priority Tier",
    description:
      "Top cities ranked by Tier 1 activation-ready customers. Stacked bars show the full priority-band mix so teams can plan first-wave vs. follow-on campaign volume by geography.",
    chartType: "bar",
    sql: "SELECT city, SUM(CASE WHEN hdbank_priority_band = 'Tier 1' THEN 1 ELSE 0 END) AS tier_1, SUM(CASE WHEN hdbank_priority_band = 'Tier 2' THEN 1 ELSE 0 END) AS tier_2, SUM(CASE WHEN hdbank_priority_band = 'Tier 3' THEN 1 ELSE 0 END) AS tier_3 FROM partnership.co_brand_silver.customer_360_v1 WHERE has_hdbank_relationship = true AND hdbank_priority_band IS NOT NULL GROUP BY city ORDER BY tier_1 DESC LIMIT 15",
    xCol: "city",
    yCol: "tier_1",
    yCols: ["tier_1", "tier_2", "tier_3"],
  },
  {
...
const DEFAULT_LAYOUT: Layout = [
  ...
  { i: "city-priority-heatmap", x: 0, y: 23, w: 2, h: 7 },
