...
impl Config {
    pub fn load() -> Self {
        Self {
            ...
            bind_addr: std::env::var("BIND_ADDR").unwrap_or("0.0.0.0:4000".to_string()),
            uc_base_url: std::env::var("UC_BASE_URL")
                .unwrap_or_else(|_| "http://localhost:8082/api/2.1/unity-catalog".to_string()),
        }
    }
}
