...
async function materializeManyAssets(paths: string[][]): Promise<{ run_id: string }> {
...
export default function AssetsPage() {
  ...
  async function handleMaterializeSelected() {
    ...
    try {
      ...
      toast.success(`Materializing ${selectedPaths.length} asset${selectedPaths.length > 1 ? 's' : ''}`, {
